...
if(30<Math.abs(this._initScrollTop-scrollTop)||10<absDScrollTop){if(isScrollingDown&&scrollTop>=maxHeaderTop){top=maxHeaderTop}else if(!isScrollingDown&&scrollTop>=this._dHeight){top=this.condenses&&!this.fixed?this._dHeight:0}var scrollVelocity=dScrollTop/(now-this._lastTimestamp);this.style.transitionDuration=this._clamp((top-lastTop)/scrollVelocity,0,300)+"ms"}else{top=this._top}}}if(0===this._dHeight){progress=0<scrollTop?1:0}else{progress=top/this._dHeight}if(!forceUpdate){this._lastScrollTop=scrollTop;this._top=top;this._wasScrollingDown=isScrollingDown;this._lastTimestamp=now}if(forceUpdate||progress!==this._progress||lastTop!==top||0===scrollTop){this._progress=progress;this._runEffects(progress,top);this._transformHeader(top)}},/**
   ...
   */getScrollState:function getScrollState(){return{progress:this._progress,top:this._top}}});registerEffect("waterfall",{/** @this {Waterfall} */run:function run(){this.shadow=this.isOnScreen()&&this.isContentBelow()}});/**
     ...
     */var Waterfall=function Waterfall(){babelHelpers.classCallCheck(this,Waterfall);/** @type {boolean} */this.shadow};Polymer({/** @override */_template:html(_templateObject4_7cdfa0f051ac11ef9195430edc66c103()),is:"app-toolbar"});/**
    @license
...
var page="/"===path?"view1":path.slice(1);// Any other info you might want to extract from the path (like page type),
// you can do here
dispatch(loadPage(page));// Close the drawer - in case the *path* change came from a link in the drawer.
dispatch(updateDrawerState(!1))}};_exports.navigate=navigate;var loadPage=function loadPage(page){return function(dispatch){switch(page){case"view1":new Promise(function(res,rej){return _require.default(["./my-view1.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$myView1||{}}).then(function(module){// Put code in here that you want to run every time when
// navigating to view1 after my-view1.js is loaded.
});break;case"view2":new Promise(function(res,rej){return _require.default(["./my-view2.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$myView2||{}});break;case"view3":new Promise(function(res,rej){return _require.default(["./my-view3.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$myView3||{}});break;default:page="view404";new Promise(function(res,rej){return _require.default(["./my-view404.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$myView404||{}});}dispatch(updatePage(page))}},updatePage=function updatePage(page){return{type:UPDATE_PAGE,page:page}},snackbarTimer,showSnackbar=function showSnackbar(){return function(dispatch){dispatch({type:OPEN_SNACKBAR});window.clearTimeout(snackbarTimer);snackbarTimer=window.setTimeout(function(){return dispatch({type:CLOSE_SNACKBAR})},3e3)}};_exports.showSnackbar=showSnackbar;var updateOffline=function updateOffline(offline){return function(dispatch,getState){// Show the snackbar only if offline status changes.
if(offline!==getState().app.offline){dispatch(showSnackbar())}dispatch({type:UPDATE_OFFLINE,offline:offline})}};_exports.updateOffline=updateOffline;var updateDrawerState=function updateDrawerState(opened){return{type:UPDATE_DRAWER_STATE,opened:opened}};_exports.updateDrawerState=updateDrawerState;var app={UPDATE_PAGE:UPDATE_PAGE,UPDATE_OFFLINE:UPDATE_OFFLINE,UPDATE_DRAWER_STATE:UPDATE_DRAWER_STATE,OPEN_SNACKBAR:OPEN_SNACKBAR,CLOSE_SNACKBAR:CLOSE_SNACKBAR,navigate:navigate,showSnackbar:showSnackbar,updateOffline:updateOffline,updateDrawerState:updateDrawerState};_exports.$app=app;var ButtonSharedStyles=css(_templateObject5_7cdfa0f051ac11ef9195430edc66c103());_exports.ButtonSharedStyles=ButtonSharedStyles;var buttonSharedStyles={ButtonSharedStyles:ButtonSharedStyles};_exports.$buttonSharedStyles=buttonSharedStyles;var INITIAL_STATE={page:"",offline:!1,drawerOpened:!1,snackbarOpened:!1},app$1=function app$1(){var state=0<arguments.length&&arguments[0]!==void 0?arguments[0]:INITIAL_STATE,action=1<arguments.length?arguments[1]:void 0;switch(action.type){case UPDATE_PAGE:return _objectSpread({},state,{page:action.page});case UPDATE_OFFLINE:return _objectSpread({},state,{offline:action.offline});case UPDATE_DRAWER_STATE:return _objectSpread({},state,{drawerOpened:action.opened});case OPEN_SNACKBAR:return _objectSpread({},state,{snackbarOpened:!0});case CLOSE_SNACKBAR:return _objectSpread({},state,{snackbarOpened:!1});default:return state;}};_exports.$appDefault=app$1;var app$2={default:app$1};// See https://github.com/zalmoxisus/redux-devtools-extension for more information.
_exports.$app$1=app$2;var devCompose=window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__||compose,store=createStore(function(state){return state},devCompose(lazyReducerEnhancer(combineReducers),applyMiddleware(thunk)));// Initializes the Redux store with a lazyReducerEnhancer (so that you can
// lazily add reducers after the store has been created) and redux-thunk (so
// that you can dispatch async actions). See the "Redux and state management"
// section of the wiki for more details:
// https://github.com/Polymer/pwa-starter-kit/wiki/4.-Redux-and-state-management
_exports.store=store;// Initially loaded reducers.
store.addReducers({app:app$1});var store$1={store:store};_exports.$store=store$1;var menuIcon=html$1(_templateObject6_7cdfa0f051ac11ef9195430edc66c103());_exports.menuIcon=menuIcon;var addToCartIcon=html$1(_templateObject7_7cdfa0f051ac11ef9195430edc66c103());_exports.addToCartIcon=addToCartIcon;var removeFromCartIcon=html$1(_templateObject8_7cdfa0f051ac11ef9195430edc66c103());_exports.removeFromCartIcon=removeFromCartIcon;var minusIcon=html$1(_templateObject9_7cdfa0f051ac11ef9195430edc66c103());_exports.minusIcon=minusIcon;var plusIcon=html$1(_templateObject10_7cdfa0f051ac11ef9195430edc66c103());_exports.plusIcon=plusIcon;var myIcons={menuIcon:menuIcon,addToCartIcon:addToCartIcon,removeFromCartIcon:removeFromCartIcon,minusIcon:minusIcon,plusIcon:plusIcon};_exports.$myIcons=myIcons;var SnackBar=/*#__PURE__*/function(_LitElement){babelHelpers.inherits(SnackBar,_LitElement);function SnackBar(){babelHelpers.classCallCheck(this,SnackBar);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(SnackBar).apply(this,arguments))}babelHelpers.createClass(SnackBar,[{key:"render",value:function render(){return html$1(_templateObject11_7cdfa0f051ac11ef9195430edc66c103())}}],[{key:"properties",get:function get(){return{active:{type:Boolean}}}},{key:"styles",get:function get(){return[css(_templateObject12_7cdfa0f051ac11ef9195430edc66c103())]}}]);return SnackBar}(LitElement);window.customElements.define("snack-bar",SnackBar);var MyApp=/*#__PURE__*/function(_connect){babelHelpers.inherits(MyApp,_connect);babelHelpers.createClass(MyApp,[{key:"render",value:function render(){// Anything that's related to rendering should be done in here.
return html$1(_templateObject13_7cdfa0f051ac11ef9195430edc66c103(),this._menuButtonClicked,menuIcon,this.appTitle,"view1"===this._page,"view2"===this._page,"view3"===this._page,this._drawerOpened,this._drawerOpenedChanged,"view1"===this._page,"view2"===this._page,"view3"===this._page,"view1"===this._page,"view2"===this._page,"view3"===this._page,"view404"===this._page,this._snackbarOpened,this._offline?"offline":"online")}}],[{key:"properties",get:function get(){return{appTitle:{type:String},_page:{type:String},_drawerOpened:{type:Boolean},_snackbarOpened:{type:Boolean},_offline:{type:Boolean}}}},{key:"styles",get:function get(){return[css(_templateObject14_7cdfa0f051ac11ef9195430edc66c103())]}}]);function MyApp(){var _this45;babelHelpers.classCallCheck(this,MyApp);_this45=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(MyApp).call(this));// To force all event listeners for gestures to be passive.
// See https://www.polymer-project.org/3.0/docs/devguide/settings#setting-passive-touch-gestures
setPassiveTouchGestures(!0);return _this45}babelHelpers.createClass(MyApp,[{key:"firstUpdated",value:function firstUpdated(){installRouter(function(location){return store.dispatch(navigate(decodeURIComponent(location.pathname)))});installOfflineWatcher(function(offline){return store.dispatch(updateOffline(offline))});installMediaQueryWatcher("(min-width: 460px)",function(){return store.dispatch(updateDrawerState(!1))})}},{key:"updated",value:function updated(changedProps){if(changedProps.has("_page")){var pageTitle=this.appTitle+" - "+this._page;updateMetadata({title:pageTitle,description:pageTitle// This object also takes an image property, that points to an img src.
